                <div class="row">
                  ...
                  <div class="col4"  role="complementary">
                    <?php if ($content['rbkc_related_content']['more_in']['#markup'] || $content['rbkc_related_content']['also_in']['#markup']): ?>
                    <div class="bordered related">
                      <!-- child menu -->
                      <?php if ($content['rbkc_related_content']['more_in']['#markup']): ?>
                      ...
                      <?php if ($content['rbkc_related_content']['also_in']['#markup']): ?>
                      <!-- sibling menu -->
